    ...
    <>
      ...
      <Routes>
        ...
        <Route path="/saisie" element={
          <ProtectedRoute roles={['admin', 'archiviste']}><Saisie /></ProtectedRoute>
        } />
        <Route path="/inventaire" element={
          <ProtectedRoute roles={['admin', 'archiviste', 'consultation']}><Inventaire /></ProtectedRoute>
        } />
        <Route path="/recherche" element={
          <ProtectedRoute roles={['admin', 'archiviste', 'consultation']}><Recherche /></ProtectedRoute>
        } />
        <Route path="/a-detruire" element={
          <ProtectedRoute roles={['admin', 'archiviste']}><ADetruire /></ProtectedRoute>
        } />
        <Route path="/referentiel" element={
          <ProtectedRoute roles={['admin', 'archiviste', 'consultation']}><Referentiel /></ProtectedRoute>
        } />
